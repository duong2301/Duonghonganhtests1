...
public class JPAConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://127.0.0.1:3306/TestingWebDatabase?characterEncoding=UTF-8&createDatabaseIfNotExist=true");
        dataSource.setUsername("root");
        dataSource.setPassword("Duong@23012");
        return dataSource;
    }
